"""
CLIP & VLM Alignment Analysis for 3-Agent Diffusion Auctions
...
It processes images generated by generate_images_3_agent.py and creates individual
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Analyze CLIP alignment and VLM quality for 3-agent generated images"
    )
    parser.add_argument(
