"""
CLIP Alignment Analysis for 2-Agent Diffusion Auctions

This script analyzes the alignment between generated images and agent prompts
using CLIP similarity scores. It processes images generated by generate_images_2_agent.py
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Analyze CLIP alignment for 2-agent generated images"
    )
    parser.add_argument(
