...
# Convenient wrapper script to run 2-agent generation with proper cache setup
# Usage: ./run_with_cache_2_agent.sh [script_args...]
...
# Fixed to 2-agent generation script
SCRIPT_NAME="generate_images_2_agent.py"

echo "=== Running 2-Agent Generation with HuggingFace Cache Setup ==="
...
# Run the 2-agent script with any additional arguments
python "$SCRIPT_NAME" "$@"

echo ""
echo "=== 2-Agent Generation Complete ==="
